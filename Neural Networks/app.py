...
class App:
    def __init__(self, settings):
        ...
        self.window.set_caption("F1 Racing - Optimal Path")
    ...
    def on_key_press(self,symbol, modifiers):
        ...
        if symbol == key.S:
            ...
            print(self.evolution.best_result.nn)
    ...
    def draw_optimal_line(self):
        # Find the best car from the previous generation
        print("hello")
        best_car = max(self.simulation.cars, key=lambda car: car.fitness_score)

        # Retrieve the optimal line of the best car
        optimal_line = best_car.optimal_line

        # Draw the optimal line
        self.graphics.draw_optimal_line(optimal_line)
    ...
    def update_labels(self, entity: Entity):
        ...
        self.graphics.hud.labels["lap_time"].text = f"Lap Time: {self.entity.lap_time:.2f} seconds"

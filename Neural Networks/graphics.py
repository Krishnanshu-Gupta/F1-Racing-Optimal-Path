...
class HUD:
    def __init__(self, width, height):
        ...
        labels_init_dict = {
            ...
            "lap_time": ["Lap Time: 0", "Comfortaa", False, 15, (255, 255, 255, 140), (10, 90)],  # New entry
...
class Graphics:
    ...
    def draw_optimal_line(self, optimal_line):
        glColor3f(1.0, 0.0, 0.0)  # Set color to red for the optimal line
        glLineWidth(3)  # Set line width

        glBegin(GL_LINE_STRIP)  # Begin drawing line strip
        for point in optimal_line:
            glVertex2f(point[0], point[1])  # Draw each point of the optimal line
